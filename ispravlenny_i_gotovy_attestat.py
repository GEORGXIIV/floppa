...
#вся эта игра пропитана иронией над своей простотой и не стоит воспринимать её как серьёзное произведение
#все совпадения совпадают
#все условия аттестации выполнены
...
background = pygame.image.load('../Floppa/8194_oasis-landscape-green_800x600.jpg')
pygame.display.set_caption("Big Russian Floppa")
s = pg.mixer.Sound('../Floppa/hihihiha.mp3')
s2 = pg.mixer.Sound('../Floppa/I Sawed the Demons.mp3')
s3 = pg.mixer.Sound('../Floppa/povezlo.mp3')
flag = True
running = True
player_sprite = pygame.image.load('../Floppa/5843-floppa-awake.png')
...
cactus = pygame.image.load('../Floppa/3953-floppa-holding-gun2.png')
...
star = pygame.transform.rotozoom(star, 0, 0.1)
star_rect = star.get_rect()
star_rect.left = size[0]
star_rect.bottom = size[1] - 100
star_speed = [0, -1]


floppa = pygame.image.load('../Floppa/8173-floppawithglasses.png')
...
resume_img = pygame.image.load('../Floppa/buttons/button_resume.png')
options_img = pygame.image.load('../Floppa/buttons/button_options.png')
quit_img = pygame.image.load('../Floppa/buttons/button_quit.png')
video_img = pygame.image.load('../Floppa/buttons/button_video.png')
audio_img = pygame.image.load('../Floppa/buttons/button_audio.png')
keys_img = pygame.image.load('../Floppa/buttons/button_keys.png')
back_img = pygame.image.load('../Floppa/buttons/button_back.png')
...
while running:
    while game_running:
        ...
        star_rect = star_rect.move(star_speed)
        ...
        if player_rect.colliderect(cactus_rect):
            score -= 0.5
            star_rect.top = player_rect.top - 100
            star_rect.right = player_rect.right
            s.play()
